...
//                                       const char* default_ret) {
//   static const char* strExt[] = {"tif", "tiff", "bmp", "jpg",  "png",
//                                  "img", "bt",   "ecw", "fits", "gif",
//                                  "hdf", "hdr",  "pix", "dat"};
//   static const char* strDescrip[] = {"GTiff", "GTiff", "BMP",    "JPEG",
//   "PNG",
//                                      "HFA",   "BT",    "ECW",    "FITS",
//                                      "GIF", "HDF4",  "EHdr",  "PCIDSK",
//                                      "ENVI"};

//   char suffix[10];
//   if (*lpstrExt == '.') {
//     strcpy(suffix, lpstrExt + 1);
//   } else {
//     strcpy(suffix, lpstrExt);
//   }
//   strlwr(suffix);
